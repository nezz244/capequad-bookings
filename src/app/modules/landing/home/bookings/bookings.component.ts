...
`,
        ...
        },
        {
            ...
            shortDescription:
                'Experience the thrill of adventure in the Grabouw mountains on a guided dune buggy tour, with a scenic waterfall stop along the way. Ride along scenic trails and enjoy panoramic views of the surrounding landscapes.',
            fullDescription: `
<div class="space-y-3 text-sm text-gray-700 leading-snug">
  <p>
    Guided <strong>dune buggy</strong> (side-by-side) tour from <strong>Trails End Hotel</strong> in the Grabouw mountains — trails, rugged terrain, a scenic <strong>waterfall stop</strong>, and wide-open views with an experienced guide. Add lunch &amp; transport when you book (per person).
  </p>
  ...
  <div>
    <h4 class="font-bold text-base mb-1">Inclusions &amp; exclusions</h4>
    <p class="mb-0.5"><span class="font-semibold">Includes:</span> guided dune buggy tour with waterfall stop, safety equipment, guide.</p>
    <p class="mb-0"><span class="font-semibold">Not included:</span> R100 nature reserve entrance permit.</p>
  </div>
</div>
`,
